...
_Generated: 2026-09-24T05:16:58.438Z_
...
Workspace `mcp.json` _(folder: GTK-Programmstarter)_

- **c:\Users\dogan\Documents\Codex\Code\C\VS\GTK-Programmstarter\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\dogan\.claude.json** — _File exists — no servers defined_
